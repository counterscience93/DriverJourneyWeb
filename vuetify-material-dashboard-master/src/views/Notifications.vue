        ...
        <material-card color="success">
          ...
          <v-card-text>
            <v-row>
              <v-col cols="12" md="6">
                ...
                <material-notification
                  ...
                  color="info"
                  dismissible
                >This is a notification with close button.</material-notification>
                ...
                <material-notification
                  ...
                  dismissible
                  icon="mdi-bell-plus"
                >This is a notification with close button and icon.</material-notification>
            ...
            >
              ...
              <div>
                Welcome to
                <b>Vuetify Material Dashboard</b> - a beautiful freebie for every web developer.
              </div>
